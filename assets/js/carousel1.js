...
//Get .carousel-control-prev
 let prevCarousel = document.querySelector("#myCaroussel carousel-control-prev");

for (var i = 0; i < rawImages.length; i++) {
	prevCarousel.addEventListener ('click', function(event){
		event.preventDefault(); 
		  event.stopPropagation();
	myCarousel.style.backgroundImage = rawImages[i++];
	}
